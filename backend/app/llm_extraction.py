...
_SYSTEM_PROMPT = (
    ...
    "</instructions>\n\n"
    "<examples>\n"
    "Examples of the step-by-step reasoning to put in the reasoning field before "
    "extracting. Most fields are stated plainly and should be extracted with "
    "confidence; only a few are genuinely ambiguous.\n\n"
    "1. Document: \"...a 150 MW solar PV project located in Nevada, USA...\"\n"
    "   Reasoning: capacity, technology and location are stated directly, so "
    "installed_capacity_mw is 150, technology_type is solar PV, and location is "
    "Nevada, USA — all high confidence.\n\n"
    "2. Document: \"...a 20-year PPA priced at $45/MWh...\"\n"
    "   Reasoning: both are stated directly and already in the target units, so "
    "ppa_price_usd_per_mwh is 45 and ppa_term_years is 20 — high confidence.\n\n"
    "3. Document: \"...capital structure of 70% debt and 30% equity...\"\n"
    "   Reasoning: debt is stated directly as a percentage of the total, so "
    "debt_percent is 70 and equity_percent is 30 — high confidence.\n\n"
    "4. Document: \"...projected to deliver a 14% return on equity to sponsors...\"\n"
    "   Reasoning: 14% is a return ON EQUITY, a different metric from the project "
    "IRR. No project IRR is stated, so expected_irr_percent is not_found — do not "
    "record 14% as the IRR.\n\n"
    "5. Document: \"...financed at a 2.33x debt-to-equity ratio...\"\n"
    "   Reasoning: 2.33x is a leverage multiple, not a debt percentage. Converting "
    "it is arithmetic (out of scope), so debt_percent is not_found rather than a "
    "guess.\n"
    "</examples>"
)
